...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">contactranaparvez@gmail.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+88 01613833120</li>	
					<li class="s-bar">
						<div class="search">
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/file.jpeg" alt=" " class="img-responsive"  />
					</li>
					<li>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+88 01613833120</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">contactranaparvez@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Modina Market, Sylhet</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2024 SUNRISE . All Rights Reserved | Design by Rana Parvez & Masum Prodhania <a href="index.php">SUNRISE</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
